...
void drawPoligonByRadius(int centerX, int centerY, int radius, int n_sides, float rotate_angle = 0, int sides_to_draw = 9999, bool onBase = true)
{
...
void drawPoligonBySide(int centerX, int centerY, int side, int n_sides, float rotate_angle = 0, int sides_to_draw = 9999, bool onBase = true)
//Calcula o raio do polígono baseado no tamanho do lado e chama a função de desenhar polígono
{
  ...
  drawPoligonByRadius(centerX,centerY, radius, n_sides, rotate_angle, sides_to_draw, onBase);
